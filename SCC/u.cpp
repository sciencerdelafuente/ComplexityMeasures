/**************************************************************************************/  
//  Computes the Sequence Compositional Complexity of a genome in fasta format
...
/**************************************************************************************/  
//** Some Author Notes:
//** SCC_4 con significaciones desde 0.99 a 0.90                     **\\
...
//Indicamos el tipo de alfabeto para el cual queremos hallar el índice. Dimensión 4: ACGT, 
...
//devuelve significacion
 ...
 //  significacion=sl_m_d(dimension,valor_JS,size);
    ...
    //S[] es de tamaño size_genome y solo tiene entradas ACGT
