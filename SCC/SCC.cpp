/**************************************************************************************/  
//  Computes the Sequence Compositional Complexity of a genome 
...
/**************************************************************************************/  
//** Output Notes:
//** SCC con todas las respectivas significaciones                          **\\
...
//devuelve significacion
 ...
 ficheroEntrada.open ("prueba.adn");
 frase_sig=0;
 ...
 while(!ficheroEntrada.eof())
 {
   ...
   if(frase[0]=='>' || (frase[0]=='S' && frase[1]=='Q') || (frase[0]=='O' && frase[1]=='R'&& frase[2]=='I' && frase[3]=='G' && frase[4]=='I' && frase[5]=='N'))
    ...
    if(region_genoma==true)
    {
         ...
         {
            if(frase.at(i)=='A' || frase.at(i)=='C' || frase.at(i)=='G' || frase.at(i)=='T')
            {
                  S[genes_introducidos]=frase.at(i);      
                  genes_introducidos++;  
            }
