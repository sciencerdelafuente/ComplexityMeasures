...
!OJO que Anew y Bnew están al revés con respecto al artículo
!*********************************************************************
real*8, parameter:: Anew4 =-6.15,Bnew4 =2.44,factor4 =0.80
real*8, parameter:: Anew2 =-7.88,Bnew2 =2.96,factor2 =0.80 !it is the same
!*********************************************************************
...
function sl_m_d(dim,d,n)
  ...
  !fitting approximation of Neff and Keff
